...
const HotSpaceListCard: React.FC<Props> = ({
  ...
  >
    ...
    {/* 순위 */}
    <span className="absolute top-3 left-3 text-white font-bold text-2xl drop-shadow-lg z-10">{rank}</span>
    {/* 제목 */}
    <span className="absolute top-10 left-3 text-white font-semibold text-base z-10">{title}</span>
